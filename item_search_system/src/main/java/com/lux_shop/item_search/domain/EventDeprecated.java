...
public class EventDeprecated implements Serializable {
    ...
    public EventDeprecated() { }

    public EventDeprecated(String team, Long date) {
        this.homeTeam = team;
        this.eventDate = date;
    }

    public EventDeprecated(Long eventId, Long eventDate, String sport, String homeTeam, String awayTeam, String city, String country) {
